...
* Purpose: This is a generic implementation of a Queue interface.
* It provides the blueprint for all required methods in the
* ListQueue.java file which implements it.
 */
